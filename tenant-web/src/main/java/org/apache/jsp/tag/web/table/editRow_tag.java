...
public final class editRow_tag extends SimpleTagSupport implements JspSourceDependent, JspSourceImports {
    ...
    public void doTag() throws JspException, IOException {
        ...
        try {
            ...
            out.write((String)PageContextImpl.proprietaryEvaluate("${label==null?\'修改\':label}", String.class, (PageContext)this.getJspContext(), (ProtectedFunctionMapper)null));
            out.write("</button>\n");
            out.write("                        </button>\n");
            out.write("\n");
