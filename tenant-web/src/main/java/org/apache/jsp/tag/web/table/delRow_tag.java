...
public final class delRow_tag extends SimpleTagSupport implements JspSourceDependent, JspSourceImports {
    ...
    public void doTag() throws JspException, IOException {
        ...
        try {
            ...
            if(!this._jspx_meth_c_005fset_005f0(_jspx_page_context)) {
                ...
                out.write("\n");
                out.write("\n");
                out.write("<button class=\"btn btn-white btn-sm\" onclick=\"deleteAll()\" data-toggle=\"tooltip\" data-placement=\"top\"><i class=\"fa fa-trash-o\"> ");
                out.write((String)PageContextImpl.proprietaryEvaluate("${label==null?\'删除\':label}", String.class, (PageContext)this.getJspContext(), (ProtectedFunctionMapper)null));
                out.write("</i>\n");
                out.write("                        </button>\n");
                out.write("\n");
                ...
                out.write("\t\t  $(\"#");
                out.write((String)PageContextImpl.proprietaryEvaluate("${id}", String.class, (PageContext)this.getJspContext(), (ProtectedFunctionMapper)null));
                out.write(" tbody tr td input.i-checks:checkbox\").each(function(){\n");
                out.write("\t\t    if(true == $(this).is(\':checked\')){\n");
                out.write("\t\t      str+=$(this).attr(\"id\")+\",\";\n");
                out.write("\t\t    }\n");
                out.write("\t\t  });\n");
                out.write("\t\t  if(str.substr(str.length-1)== \',\'){\n");
                out.write("\t\t    ids = str.substr(0,str.length-1);\n");
                out.write("\t\t  }\n");
                out.write("\t\t  if(ids == \"\"){\n");
                out.write("\t\t\ttop.layer.alert(\'请至少选择一条数据!\', {icon: 0, title:\'警告\'});\n");
                out.write("\t\t\treturn;\n");
                out.write("\t\t  }\n");
                out.write("\t\t\ttop.layer.confirm(\'确认要彻底删除数据吗?\', {icon: 3, title:\'系统提示\'}, function(index){\n");
