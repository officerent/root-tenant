...
public final class page_tag extends SimpleTagSupport implements JspSourceDependent, JspSourceImports {
    ...
    public void doTag() throws JspException, IOException {
        ...
        if(this.getPage() != null) {
            _jspx_page_context.setAttribute("page", this.getPage());
        }
        ...
        try {
            ...
            if(!this._jspx_meth_c_005fset_005f1(_jspx_page_context)) {
                ...
                out.write(10);
                out.write(10);
                out.write((String)PageContextImpl.proprietaryEvaluate("${page}", String.class, (PageContext)this.getJspContext(), (ProtectedFunctionMapper)null));
                out.write("\n");
