...
function I(G, _) {
    ...
    function E(K, J) {
        ...
        function C() {
            ...
            J.setPos = B;
            J.onload = Z;
            H.write("<!--[if lt IE 7]><html class=\"ie ie6 lt8 lt9\"><![endif]--><!--[if IE 7]><html class=\"ie ie7 lt8 lt9\"><![endif]--><!--[if IE 8]><html class=\"ie ie8 lt9\"><![endif]--><!--[if IE 9]><html class=\"ie ie9\"><![endif]--><!--[if (gt IE 9) | !(IE)]><!--><html><!--<![endif]-->");
            H.cfg = J;
            H.write($.join(""));
            H.close()
        }
