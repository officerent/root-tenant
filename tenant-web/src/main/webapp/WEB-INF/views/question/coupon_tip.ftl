        ...
        <div class="content">
            ...
            <div class="content-body">
                <ul class="timeline">
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                    1.在我们网站下完订单后,你会收到一条3Q平台给你发送的一条信息,点击给你的链接地址
                                </p>
                                <img src="${path}/wrap/images/coupon/1.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    <li class="timeline-item">
                        ...
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                ...
                                <img src="${path}/wrap/images/coupon/2.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                ...
                                <img src="${path}/wrap/images/coupon/3.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    ...
                    <li class="timeline-item">
                        <div class="timeline-badge">
                            <a class="border-orange" rel="tooltip" data-container="body" href="#" title="" data-original-title="4"></a>
                        </div>
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                ...
                                <img src="${path}/wrap/images/coupon/4.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    <li class="timeline-item">
                        <div class="timeline-badge">
                            <a class="border-orange" rel="tooltip" data-container="body" href="#" title="" data-original-title="5"></a>
                        </div>
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                ...
                                <img src="${path}/wrap/images/coupon/5.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    ...
                    <li class="timeline-item">
                        <div class="timeline-badge">
                            <a class="border-orange" rel="tooltip" data-container="body" href="#" title="" data-original-title="6"></a>
                        </div>
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                ...
                                <img src="${path}/wrap/images/coupon/6.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    <li class="timeline-item">
                        <div class="timeline-badge">
                            <a class="border-orange" rel="tooltip" data-container="body" href="#" title="" data-original-title="7"></a>
                        </div>
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                ...
                                <img src="${path}/wrap/images/coupon/7.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                    <li class="timeline-item">
                        <div class="timeline-badge">
                            <a class="border-orange" rel="tooltip" data-container="body" href="#" title="" data-original-title="8"></a>
                        </div>
                        <div class="timeline-panel panel fade in panel-default panel-fill" data-fill-color="true" data-init-panel="true">
                            <div class="panel-body">
                                <p>
                                ...
                                <img src="${path}/wrap/images/coupon/8.PNG">
                            </div><!-- /.panel-body -->
                        </div><!-- /.timeline-panel -->
                    </li><!-- /.timeline-item -->
                </ul>
